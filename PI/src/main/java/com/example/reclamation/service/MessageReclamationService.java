...
public class MessageReclamationService {
    ...
    /**
     * Fetches the reclamation text, calls the Flask auto‐reply API, saves the reply as a new message,
     * and marks the original reclamation as RESOLUE.
     *
     * @param userId         the UUID of the user sending the reply
     * @param reclamationId  the UUID of the reclamation to reply to
     * @return               the text auto‐reply generated by the Flask API
     * @throws Exception     on any database, HTTP, or JSON parsing error
     */
    public String generateAutoReply(UUID userId, UUID reclamationId) throws Exception {
        // 1) Load the reclamation’s title + description
